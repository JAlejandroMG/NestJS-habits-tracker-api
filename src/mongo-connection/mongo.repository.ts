...
import {
  MONGO_DB_TOKEN,
  REPOSITORY_COLLECTION_NAME_TOKEN,
} from 'src/utils/constants';
import { FindAllQuery } from './models/mdb-find-all-query.type';

@Injectable()
export class MongoDbRepository<EntityModel extends { _id: ObjectId }> {
